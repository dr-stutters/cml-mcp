...
| [SD-Access ISE Integration](SD-Access%20ISE%20Integration/) | [runbook.md](SD-Access%20ISE%20Integration/runbook.md) + 5 modules + [PLAN.md](SD-Access%20ISE%20Integration/PLAN.md) | ✅ validated (fresh ISE 3.5 → `mitchcloud.lab` AD + CatC ACTIVE, all certs MitchcloudCA; Closed Auth — **MAB→SGT IoT** & **802.1X PEAP/AD→SGT Employees** live; SGACL matrix programmed on the edge, data-plane drop is a documented CML limit) | ise-engineer, catalyst-center-engineer, windows-engineer, catalyst-engineer |
