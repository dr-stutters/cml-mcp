...
| [SD-Access Fabric](SD-Access%20Fabric/) | [runbook.md](SD-Access%20Fabric/runbook.md) + [CLI](SD-Access%20Fabric/modules/cli-provisioning.md)/[CatC](SD-Access%20Fabric/modules/catc-provisioning.md) modules + 2 roadmap + [topology.yaml](SD-Access%20Fabric/topology.yaml) | ✅ CLI LISP fabric validated (no ISE; host EID registered on cat9000v 17.18) · ⚠️ CatC provisioning blocked (NCSP11008) | catalyst-engineer, catalyst-center-engineer, cml-lab-architect |
